            ...
            render={({ field }) => (
                ...
                <FormControl>
                    <div className='flex-center h-[54px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2'>
                        ...
                        <DatePicker wrapperClassName="datePicker" selected={field.value} onChange={(date: Date) => field.onChange(date)} showTimeSelect timeInputLabel='Time:' dateFormat='MM/dd/yyyy h:mm aa'/>
                    </div>
                </FormControl>
                <FormMessage />
                </FormItem>
